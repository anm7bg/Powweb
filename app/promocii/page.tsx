      ...
      <div ref={container}>
          ...
          <div className="promocii hero p-[20px] text-[1.2rem] ">
              ...
              <h2 className="text-center text-[1.7rem]">
                  ...
                  <h3>Допълнителни добавки срещу заплащане:</h3>
                  <ul>
                    <li>Инсталиране и настройка на платформа за ел. търговия от 100 до 200лв.</li>
                    <li>Инсталиране и настройка на допълнителен език - 100лв.</li>
                  </ul>
                  <p className="text-center">Ние предлагаме също и поддръжка и оптимизация на съществуващи уебсайтове на разумни цени.</p>
                  <p className="text-center">Ако решите да ни се доверите, може да се свържете с нас на имейл: Powwebs@gmail.com.</p>
              </div>
              <div className="hero__body opacity-0 home-wrap-light bg-gradient-to-b from-gray-900 to-gray-95 p-[20px]">
              <h2 className="text-center text-[1.7rem]">
                      Цената е валидна до 15 Март!!!
                  </h2>
                  <p className="text-center">Здравейте, промоцията включва изработване на сайт с базова функционалност и брой страници.</p>
